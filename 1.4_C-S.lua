...
print("Versao: 1.4 C-S")
sleep(4)
if fs.exists(".mUbuntu/MineUbuntu.dll") == true then
seleciona()
else
term.clear()
term.setCursorPos(1,1)
...
function chave()
fs.makeDir(".mUbuntu")
local fh = io.open(".mUbuntu/MineUbuntuPorta.dll", "w")
...
function pc()
fs.makeDir(".mUbuntu")
local fh = io.open(".mUbuntu/MineUbuntuPc.dll", "w")
...
function ilumina()
fs.makeDir(".mUbuntu")
local fh = io.open(".mUbuntu/MineUbuntuLuz.dll", "w")
...
print("Digite o numero, de qual lado do computador o fio estÃ?Â¡ tocando:")
...
fs.makeDir(".mUbuntu")
local fh = io.open(".mUbuntu/MineUbuntuLado.dll", "w")
fh:write(lado)
fh:close()
print(lado)
end
...
print(ww)
fs.makeDir(".mUbuntu")
local fh = io.open(".mUbuntu/sys", "w")
fh:write(ww)
fh:close()
sleep(3)
term.clear()
...
function seleciona()
if fs.exists(".mUbuntu/MineUbuntuPorta.dll") == true then
sysPorta()
end
end
function sysPorta()
...
local fh = io.open(".mUbuntu/sys", "r")
