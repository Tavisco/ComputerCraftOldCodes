...
print("|_|  |_|_|_||_\\___|\\___/|_.__/\\_,_|_||_\\__|\\_,_|")
print("")
print("Bem-vindo(a) " .. lLogin .. " ao MineUbuntu!")
print("Para travar o PC, quando sair, use o comando: travar")
print("Ele ira automaticamente desligar o PC, mas quando ligar novamente")
print("pedira senha.")
else
term.clear()
term.setCursorPos(1,2)
