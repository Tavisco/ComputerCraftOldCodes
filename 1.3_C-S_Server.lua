...
term.clear()
term.setCursorPos(1,1)
print("Por favor, cabeie usando Allow-Wires, ou Insulated-Wires, do Pc até à(s) lampada(as) que funcionam com redstone. Lembre-se: A lampada nao ira ligar se houver contato com um ALLOW-WIRE.")
print("Digite o numero, de qual lado do computador o fio está tocando:")
